...
- 唯一可讀寫的實作目錄：`20260814/model-showdown/submissions/model-b/**`
- 你的執行目錄應固定為：`20260814/model-showdown/submissions/model-b`
...
2. `20260814/model-showdown/submissions/model-b/**`

你只能修改：

1. `20260814/model-showdown/submissions/model-b/**`

不得讀取、列舉、搜尋、開啟、摘要或修改下列內容：

- `20260814/model-showdown/evaluation/**`
- `20260814/model-showdown/reports/**`
- `20260814/model-showdown/submissions/model-a/**`
